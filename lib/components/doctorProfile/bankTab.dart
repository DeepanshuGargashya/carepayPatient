...
class BankTabScreen extends StatefulWidget {
  @override
...
class BankTabState extends State<BankTabScreen>
            ...
            child: Column(
              children: [
                ...
                EachDetailWidget(
                  ...
                  editController: controller.editAccountController,
                  formKey: _formKeyEditAccount,
                  header: TextConstant.accountNumber,
                ),
                SizedBox(
                  width: 1,
                  height: 10 * fem,
                ...
                EachDetailWidget(
                  ...
                  editController: controller.editHolderNameController,
                  formKey: _formKeyEditHolderName,
                  header: TextConstant.acountHolderName,
                ),
                SizedBox(
                  width: 1,
                  height: 10 * fem,
                ...
                EachDetailWidget(
                  ...
                  editController: controller.editIFSCController,
                  formKey: _formKeyEditIFSC,
                  header: TextConstant.ifsc,
                ),
                SizedBox(
                  width: 1,
                  height: 10 * fem,
                ...
                EachDetailWidget(
                  ...
                  editController: controller.editBankNameController,
                  formKey: _formKeyEditBankName,
                  header: TextConstant.bankName,
                ),
                SizedBox(
                  width: 1,
                  height: 10 * fem,
                ...
                EachDetailWidget(
                  ...
                  editController: controller.editBranchNameController,
                  formKey: _formKeyEditBranchName,
